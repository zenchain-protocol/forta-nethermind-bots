...
async function mockDataFetcherCreator(): Promise<DataFetcher> {
...
describe("Native Ice Phishing Bot test suite", () => {
  ...
  // TODO: This test code below requires serious reworking for V2 and ethers upgrade as it makes heavy use of mocking
  ...
  //     await handleRealTransaction(otherTxEvent, realProvider);
  ...
  //     await handleRealTransaction(nativeTransferTxEvent, realProvider);
  ...
  //     await handleRealTransaction(suspiciousNativeTransferTxEvent, realProvider);
  ...
  //     await handleRealTransaction(phishingContractDeploymentTxEvent, realProvider);
  ...
  //     await handleRealTransaction(ownerWithdrawalTxEvent, realProvider);
  ...
  //     await handleRealTransaction(socialEngineeringEoaTxEvent, realProvider);
  ...
  //     await handleRealTransaction(socialEngineeringContractTxEvent, realProvider);
  ...
  //   // TODO: Figure out why we're not getting any findings here, even prior to V2 upgrade
  //   expect(findings).toStrictEqual([
